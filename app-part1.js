...
const dict = {
    uz: {
        ...
        rainLight: "Yengil yomg'ir", rainModerate: "Yomg'irli", rainHeavy: "Kuchli yomg'ir",
        mainRainLight: "Yengil yomg'ir", mainRainNormal: "Yomg'ir", mainRainHeavy: "Kuchli yomg'ir",
        ...
        weekWarnStormDry: "momaqaldiroq", weekWarnStormRain: "momaqaldiroqli yomg'ir", weekWarnRainNormal: "yomg'ir", weekWarnTempSwing: "haroratning keskin o'zgarishi",
        weekWarnRainWind: "yomg'ir va kuchli shamol",
        ...
        clothVeryCold: "Juda sovuq. Undan ham qalinroq kiyim va sovuqdan himoyalovchi boshqa vositalardan foydalaning.",
        clothCold: "Sovuq. Kiyimni shunga mos, issiqroq tanlang.",
        clothCool: "Salqin. Jemper yoki qalinroq kiyim tanlang.",
        clothMild: "Harorat qulay. Oddiy kundalik kiyim bilan bemalol yurishingiz mumkin.",
        clothHot: "Issiq. Yengil, havo o'tkazuvchan kiyim kiying.",
        clothVeryHot: "Juda issiq. Quyoshdan himoyalanish tavsiya etiladi.",
        clothVeryHotNight: "Kechasi ham havo issiq. Yengil kiyim va yetarli suyuqlik foydali.",
        uvNightMsg: "Hozir tun, UV nurlanishi mavjud emas.",
        sportUVBad: "Quyosh kuchli. Sportni salqinroq vaqtga qoldiring.",
        sportAQIBad: "Havo sifati yomon. Ochiq havodagi mashqni cheklang.",
        carLowVis: "Ko'rish cheklangan. Tezlikni kamaytirib, ehtiyotkor haydang.",
        avLowVis: "Ko'rish masofasi past. Ayrim reyslarda kechikish ehtimoli mavjud.",
        ...
        tempVeryCold: "🥶 Juda sovuq", tempCold: "❄️ Sovuq", tempHot: "🥵 Issiq", tempVeryHot: "🔥 Juda issiq", extremeFrost: "🧊 Muzlash xavfi",
        condFog: "🌫️ Tuman", condLowVis: "🌫️ Ko'rish cheklangan", condVeryLowVis: "🌫️ Ko'rish juda past", condHighUV: "☀️ Yuqori UV", condBadAQI: "😷 Havo sifati yomon",
        extremeRain: "⚠️ KUCHLI YOMG'IR!", extremeSnow: "⚠️ KUCHLI QOR!", moderateRain: "🌧️ Yomg'ir", lightRain: "🌦️ Yengil yomg'ir",
        ...
        pressureSlightlyLow: "Biroz past", pressureSlightlyHigh: "Biroz yuqori",
        visExcellent: "A'lo", visGood: "Yaxshi", visSatisfactory: "Qoniqarli", visLimited: "Cheklangan", visVeryLow: "Juda past",
    ...
    ru: {
        ...
        rainLight: "Небольшой дождь", rainModerate: "Дождь", rainHeavy: "Сильный дождь",
        mainRainLight: "Небольшой дождь", mainRainNormal: "Дождь", mainRainHeavy: "Сильный дождь",
        ...
        weekWarnStormDry: "гроза", weekWarnStormRain: "гроза с дождём", weekWarnRainNormal: "дождь", weekWarnTempSwing: "резкое изменение температуры",
        weekWarnRainWind: "дождь и сильный ветер",
        ...
        clothVeryCold: "Очень холодно. Используйте ещё более тёплую одежду и другие средства защиты от холода.",
        clothCold: "Холодно. Одевайтесь теплее, подбирая одежду соответственно.",
        clothCool: "Прохладно. Выберите свитер или более тёплую одежду.",
        clothMild: "Комфортная температура. Можно спокойно ходить в обычной повседневной одежде.",
        clothHot: "Жарко. Носите лёгкую, дышащую одежду.",
        clothVeryHot: "Очень жарко. Рекомендуется защита от солнца.",
        clothVeryHotNight: "Ночью тоже жарко. Полезны лёгкая одежда и достаточное количество жидкости.",
        uvNightMsg: "Сейчас ночь, УФ-излучения нет.",
        sportUVBad: "Солнце сильное. Перенесите тренировку на более прохладное время.",
        sportAQIBad: "Качество воздуха плохое. Ограничьте нагрузки на улице.",
        carLowVis: "Видимость ограничена. Снизьте скорость и будьте осторожны.",
        avLowVis: "Видимость снижена. Возможны задержки некоторых рейсов.",
        ...
        tempVeryCold: "🥶 Очень холодно", tempCold: "❄️ Холодно", tempHot: "🥵 Жарко", tempVeryHot: "🔥 Очень жарко", extremeFrost: "🧊 Риск обледенения",
        condFog: "🌫️ Туман", condLowVis: "🌫️ Видимость ограничена", condVeryLowVis: "🌫️ Видимость очень низкая", condHighUV: "☀️ Высокий УФ", condBadAQI: "😷 Плохое качество воздуха",
        extremeRain: "⚠️ СИЛЬНЫЙ ЛИВЕНЬ!", extremeSnow: "⚠️ СИЛЬНЫЙ СНЕГОПАД!", moderateRain: "🌧️ Дождь", lightRain: "🌦️ Небольшой дождь",
        ...
        pressureSlightlyLow: "Немного низкое", pressureSlightlyHigh: "Немного высокое",
        visExcellent: "Отличная", visGood: "Хорошая", visSatisfactory: "Удовлетворительная", visLimited: "Ограниченная", visVeryLow: "Очень низкая",
    ...
    en: {
        ...
        rainLight: "Light rain", rainModerate: "Rainy", rainHeavy: "Heavy rain",
        mainRainLight: "Light rain", mainRainNormal: "Rain", mainRainHeavy: "Heavy rain",
        ...
        weekWarnStormDry: "a thunderstorm", weekWarnStormRain: "a thunderstorm with rain", weekWarnRainNormal: "rain", weekWarnTempSwing: "a sharp temperature change",
        weekWarnRainWind: "rain and strong wind",
        ...
        clothVeryCold: "Very cold. Use even warmer clothing and other cold-protection measures.",
        clothCold: "Cold. Dress accordingly with warmer clothing.",
        clothCool: "Cool. Choose a sweater or warmer clothing.",
        clothMild: "The temperature is comfortable. Regular everyday clothing works just fine.",
        clothHot: "Hot. Wear light, breathable clothing.",
        clothVeryHot: "Very hot. Sun protection is recommended.",
        clothVeryHotNight: "It's still hot at night. Light clothing and plenty of fluids will help.",
        uvNightMsg: "It's nighttime — no UV exposure right now.",
        sportUVBad: "Sun is strong. Push your workout to a cooler time of day.",
        sportAQIBad: "Air quality is poor. Limit outdoor exertion.",
        carLowVis: "Visibility is limited. Slow down and drive carefully.",
        avLowVis: "Visibility is reduced. Some flights may be delayed.",
        ...
        tempVeryCold: "🥶 Very cold", tempCold: "❄️ Cold", tempHot: "🥵 Hot", tempVeryHot: "🔥 Very hot", extremeFrost: "🧊 Frost risk",
        condFog: "🌫️ Fog", condLowVis: "🌫️ Limited visibility", condVeryLowVis: "🌫️ Very low visibility", condHighUV: "☀️ High UV", condBadAQI: "😷 Poor air quality",
        extremeRain: "⚠️ HEAVY RAIN!", extremeSnow: "⚠️ HEAVY SNOW!", moderateRain: "🌧️ Rain", lightRain: "🌦️ Light rain",
        ...
        pressureSlightlyLow: "Slightly low", pressureSlightlyHigh: "Slightly high",
        visExcellent: "Excellent", visGood: "Good", visSatisfactory: "Satisfactory", visLimited: "Limited", visVeryLow: "Very low",
...
// ============================================================
// LIGHTNING FLASH ENGINE (thunder / thunder+rain only)
// - a strike fires roughly every ~5s
// - each strike comes from a single side (left or right), never both
// - left runs 2-4 strikes in a row, then switches to the right
// - the right-side run length is random and never repeats the
//   immediately previous right-side run length
// - each flash is a soft, brief edge glow (never covers the center
//   content) with a quick attack and a short fade-out
...
function initLightningState() {
    lightningState = {
        side: 'left',
        streakTarget: 2 + Math.floor(Math.random() * 3), // 2-4
        streakCount: 0,
        lastFlashTs: 0,
        nextDelay: 4200 + Math.random() * 1600, // ~5s cadence with jitter
        lastRightStreak: -1,
        flashes: []
    };
}

function pickNextRightStreak() {
    let n;
    do {
        n = 2 + Math.floor(Math.random() * 4); // 2-5
    } while (n === lightningState.lastRightStreak);
    lightningState.lastRightStreak = n;
    return n;
}

function triggerLightningEvent(ts) {
    const s = lightningState;
    s.flashes.push({ side: s.side, startTs: ts, duration: 260 + Math.random() * 120 });

    s.streakCount++;
    if (s.streakCount >= s.streakTarget) {
        s.side = s.side === 'left' ? 'right' : 'left';
        s.streakCount = 0;
        s.streakTarget = s.side === 'right' ? pickNextRightStreak() : (2 + Math.floor(Math.random() * 3));
    }
    s.lastFlashTs = ts;
    s.nextDelay = 4200 + Math.random() * 1600;
}

function drawLightning(ts) {
    if (!lightningState) initLightningState();
    const s = lightningState;
    const reduced = prefersReducedMotion();

    if (!reduced && ts - s.lastFlashTs > s.nextDelay) {
        triggerLightningEvent(ts);
    }

    s.flashes = s.flashes.filter(f => (ts - f.startTs) < f.duration);
    s.flashes.forEach(f => {
        const elapsed = ts - f.startTs;
        const progress = elapsed / f.duration;
        // Quick attack (25% of duration), gentle fade-out over the rest
        const alpha = progress < 0.25 ? (progress / 0.25) * 0.45 : 0.45 * (1 - (progress - 0.25) / 0.75);
        const w = canvas.width * 0.4;
        const grad = f.side === 'left'
    ...
    function animate(ts) {
        ...
        if (type === 'stars') {
            ...
            particles.forEach(p => {
                ...
                p.y += p.v * 0.6;
                p.x += Math.sin((p.y + p.twinkle * 40) * 0.02) * 0.6;
            ...
            if (type === 'storm') {
                drawLightning(ts || performance.now());
            }
        }
...
function isNightAtTime(timeStr, dailyData, fallbackIsNight) {
    ...
    if (!sunriseStr || !sunsetStr) return fallbackIsNight;
...
function getWeatherEmoji(code, isNight, windKmh, precipAmount) {
    ...
    if (code === 1 || code === 2) return isNight ? NIGHT_PARTLY_CLOUDY_SVG : "🌤️";
    if (code === 3) return "☁️";
...
async function prewarmHistoryCache() {
    ...
    for (const city of searchHistory) {
        ...
        if (existing && Date.now() - (existing.ts || 0) < 30 * 60 * 1000) continue;
        try {
